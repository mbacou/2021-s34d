...
ggplot(hh, aes(gender, margin_ha_sh, fill=gender)) +
  ...
  labs(x="", y="", fill="",
    ...
    subtitle="Stratified by Gender (% of variable input costs)") +
  theme_def(legend.position="none")
...
ggplot(hh, aes(group, margin_ha_ppp, fill=group)) +
  ...
  labs(x="", y="", fill="",
    title="Gross Profit Margin in Absolute Terms",
    subtitle="Stratified by Farmer Group (PPP$ / ha)") +
  theme_def(legend.position="none")
...
ggplot(hh, aes(group, margin_ha_sh, fill=group)) +
  ...
  labs(x="", y="", fill="",
    title="Gross Profit Margin in Relative Terms",
    subtitle="Stratified by Farmer Group (% of variable input costs)") +
  theme_def(legend.position="none")
