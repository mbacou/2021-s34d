...
tmp <- hh[, .N, by=.(adm1_nm, group, ssd_formal, gender)]

library(ggalluvial)
ggplot(tmp, aes(axis1=adm1_nm, axis2=gender, axis3=ssd_formal, y=N)) +
  ...
  theme_def() +
  ggtitle("Vietnam Survey Respondents",
          "Stratified by demographics and group membership")
