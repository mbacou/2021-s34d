...
hh[, summary(sales_ha_lcu)]

```

Note that 6 respondents indicate no sales this past season (crop failure or decision not to sell):

```{r}

kbl(hh[sales_ha_lcu==0, .(hhid, group, adm2_nm, costs_ha_lcu, yield_ha_kg, sales_ha_kg)])
