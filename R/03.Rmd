...
gropu <- fread("../data/gtm/group.csv")
...
hh_prod_cost <- hh[, .(hhid,
  ...
  Labeling = fifelse(crop=="bean", 1/1.36, 1/22.68) * sales_ha_kg * labl_kg_lcu,
  Packaging = fifelse(crop=="bean", 1/1.36, 1/22.68) * sales_ha_kg * pckg_kg_lcu,
