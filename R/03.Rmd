...
hh[, `:=`(
  ...
  age = factor(age, labels=c(`< 30`="15-29", `≥ 30`="30"))
)]
...
ggplot(
  ...
  aes(axis1=adm1_nm, axis2=crop, axis3=gender, axis4=age, y=N)) +
...
mosaicplot(~adm1_nm+age, hh, shade=T,
